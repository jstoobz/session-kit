...
1. **Check for existing file** — Read `./HONE.md` if it exists. If found:
...
6. Write `HONE.md` in the current working directory.
...
- Write to `./HONE.md` unless the user specifies a different path
